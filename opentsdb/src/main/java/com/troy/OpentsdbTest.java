 ...
 * @description:
 * @author: ShadowMo
 * @createtime: 2019-05-06 09:46
 */
public class OpentsdbTest {

    private static Logger log = LoggerFactory.getLogger(OpentsdbTest.class);
    ...
    public OpentsdbTest(String opentsdbUrl) {
    ...
    public String getData(String metric, String tagk, String tagvFtype, String tagvFilter, String aggregator, String downsample,
        ...
        query.setStart(DateUtil.parseStrToDate(startTime, "yyyy-MM-dd HH:mm:ss").getTime() / 1000);
        query.setEnd(DateUtil.parseStrToDate(endTime, "yyyy-MM-dd HH:mm:ss").getTime() / 1000);
        ...
        if (array != null) {
            for (int i = 0; i < array.size(); i++) {
                ...
                for (Iterator<String> it = dps.keySet().iterator(); it.hasNext(); ) {
                    ...
                    timeValueMap.put(DateUtil.parseDateToStr(datetime, retTimeFmt), dps.get(timstamp));
                }
